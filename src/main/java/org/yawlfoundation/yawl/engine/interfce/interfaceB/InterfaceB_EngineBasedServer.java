...
public class InterfaceB_EngineBasedServer extends YHttpServlet {
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            _log.error("Failure to initialise runtime (persistence failure)", e);
        ...
        if (_engine != null) {
            ...
            _log.error("Failed to initialise Engine (unspecified failure). Please " +
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        {
            _log.error("************************************************************");
            _log.error("A failure has occurred whilst persisting workflow state to the");
            _log.error("database. Check the status of the database connection defined");
            _log.error("for the YAWL service, and restart the YAWL web application.");
            _log.error("Further information may be found within the Tomcat log files.");
            _log.error("************************************************************");
    ...
    private String processPostQuery(HttpServletRequest request) {
        ...
        try {
            ...
            if (action != null) {
                ...
                else if(action.equals("deleteAllCases")){
